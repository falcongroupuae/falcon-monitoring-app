...
import { FaBell, FaCog, FaUser, FaSignOutAlt, FaChevronDown } from "react-icons/fa";
    ...
    <header className="h-18 bg-gray-200 sticky top-0 z-50 ">
      <div className="h-full flex items-center justify-between px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <IoIosArrowBack className="text-gray-600 group-hover:text-red-600 text-lg transition-colors" />
          </button>
        </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden md:block text-left">
                ...
                <p className="text-xs text-gray-500">john@falcon.com</p>
              </div>
                ...
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-lg border border-gray-200 z-20">
                  ...
                  <div className="p-4 border-b flex gap-2 border-gray-200">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-0.5">john@falcon.com</p>
                    </div>
                  </div>
                  <div className="p-2">
