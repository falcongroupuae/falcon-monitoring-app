...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      else if (status === 422) message = "Invalid login request.";
        ...
        <div className="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
          <div className="flex-1">
            <div className="text-center">
              <div className="flex items-center justify-center">
                <img
                  src="/falcon-logo.png"
                  alt="Falcon Icon"
                  className="w-32 object-contain flex-shrink-0 block dark:hidden"
                />

                {/* Dark mode logo */}
                <img
                  src="/falcon-group-white-logo.png"
                  alt="Falcon Icon"
                  className="w-32 object-contain flex-shrink-0 hidden dark:block"
                />
              </div>
              <p className="mt-3 text-gray-500 dark:text-gray-200">
            ...
            <div className="mt-8">
              <form onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="block w-full px-4 py-2 mt-2 text-gray-700 dark:text-gray-200 placeholder-gray-400 
                      bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md 
                      focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40 transition-colors"
                  />
                </div>
                ...
                <div className="mt-6">
                  <div className="flex justify-between mb-2">
                    ...
                    <a href="#" className="text-sm text-gray-400 dark:text-gray-500 cursor-pointer hover:underline">
                      Forgot password ?
                    </a>
                  </div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="block w-full px-4 py-2 mt-2 text-gray-700 dark:text-gray-200 placeholder-gray-400 
                        bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md 
                        focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40 pr-10 transition-colors"
                    />
              ...
              <p className="mt-6 text-sm text-center text-gray-400 dark:text-gray-200">
